...
public class RSAUtil {
    ...
    public static Map<String, Object> genKeyPair(int keySize) throws Exception {
        ...
        System.out.println("publicKey：" + Base64.encodeToString(publicKey.getEncoded(),Base64.DEFAULT));
        System.out.println("privateKey：" + Base64.encodeToString(privateKey.getEncoded(),Base64.DEFAULT));
